...
function graphDFS(graph: GraphMatrix) {
  ...
  function dfsR(v: number) {
    ...
    // * Nota: A matriz de adjacência é uma matriz de 0/1, onde 1 significa que o vértice é adjacente, o valor isAdjacent é o valor da matriz, w é o vértice adjacente que está na posição (index) w da matriz
